...
// Source: https://github.com/dotnet/MQTTnet/blob/master/Source/MQTTnet/MqttTopicFilterComparer.cs
...
namespace LoraRouter.ChirpStack
{
    ...
    public static class MqttTopicFilterComparer
    {
        ...
        public static MqttTopicFilterCompareResult Compare(string topic, string filter)
        {
            ...
            StringBuilder topicPointer = new StringBuilder(topic);
            StringBuilder filterPointer = new StringBuilder(filter);
